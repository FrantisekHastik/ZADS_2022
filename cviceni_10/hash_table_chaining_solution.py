...
def htc_insert(table: HashTableChain, key : int):
    index = htc_hash(table, key)
    insert_start(table.data[index], key)

def htc_search(table: HashTableChain, key : int):
    table_index = htc_hash(table, key)
    list_index, _ = l_search(table.data[table_index], key)
    return table_index, list_index

def htc_delete(table: HashTableChain, key : int):
    t_index, l_index = htc_search(table, key)
    delete_nth(table.data[t_index], l_index)
